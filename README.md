...
- [`1.26.0`, `latest` (*1.26.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.26.0)
- [`1.25.2`, (*1.25.2/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.25.2)
- [`1.25.1`, (*1.25.1/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.25.1)
- [`1.25.0`, (*1.25.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.25.0)
...
- [`1.19.3`, (*1.19.3/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.19.3)
- [`1.19.2`, (*1.19.2/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.19.2)
- [`1.19.1`, (*1.19.1/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.19.1)
- [`1.19.0`, (*1.19.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.19.0)
- [`1.18.0`, (*1.18.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.18.0)
- [`1.17.1`, (*1.17.1/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.17.1)
- [`1.17.0`, (*1.17.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.17.0)
- [`1.16.3`, (*1.16.3/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.16.3)
- [`1.16.2`, (*1.16.2/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.16.2)
- [`1.16.1`, (*1.16.1/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.16.1)
- [`1.16.0`, (*1.16.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.16.0)
- [`1.15.0`, (*1.15.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.15.0)
- [`1.14.0`, (*1.14.0/Dockerfile*)](https://github.com/MajorP93/unbound-docker/tree/master/1.14.0)
...
ghcr.io/majorp93/unbound:latest
```
...
*Note: The example [unbound.conf](unbound.conf) file is different from the one set by [unbound.sh file](1.17.0/data/unbound.sh). The example is provided to help you re-configure this as a [recursive server](https://github.com/MajorP93/unbound-docker#recursive-config).*
...
services:
  unbound:
    ...
    image: "ghcr.io/majorp93/unbound:latest"
    expose:
      - "53"
    networks:
      - dns
...
Documentation for this image is stored right here in the [`README.md`](https://github.com/MajorP93/unbound-docker/blob/master/README.md).
...
through a [GitHub issue](https://github.com/MajorP93/unbound-docker/issues).
...
file](https://github.com/MajorP93/unbound-docker/blob/master/README.md)
before attempting a pull request.

Before you start to code, I recommend discussing your plans through a [GitHub
issue](https://github.com/MajorP93/unbound-docker/issues), especially for
...
file](https://github.com/MajorP93/unbound-docker/blob/master/LICENSE) for
details.
